...
// The last value is 10 because the last iteration is with 9 then it gets incremented. The next time it evaluates is false so the print is not executed
...
// you could use count > 0 or count >= 1
